														...
														<div class="cv-card__body">
															...
															<form action="updateHackathon" method="post">
																...
																<div class="cv-form-group">
																	...
																	<input type="text" name="title" class="cv-input"
																...
																<div class="cv-form-group">
																	...
																	<select name="status" class="cv-select" required>
																		<option value="UPCOMING"
																			${hackathon.status=='UPCOMING' ? 'selected'
																			: '' }>Upcoming</option>
																		<option value="ONGOING"
																			${hackathon.status=='ONGOING' ? 'selected'
																			: '' }>Ongoing</option>
																		<option value="IN_PROGRESS"
																			${hackathon.status=='IN_PROGRESS'
																			? 'selected' : '' }>In Progress</option>
																		<option value="Close"
																			${hackathon.status=='Close' ? 'selected'
																			: '' }>Closed</option>
																		<option value="COMPLETED"
																			${hackathon.status=='COMPLETED' ? 'selected'
																			: '' }>Completed</option>
																	</select>
																</div>
																...
																<div class="cv-form-group">
																	...
																	<select name="eventType" class="cv-select" required>
																		<option value="ONLINE"
																			${hackathon.eventType=='ONLINE' ? 'selected'
																			: '' }>Online</option>
																		<option value="OFFLINE"
																			${hackathon.eventType=='OFFLINE'
																			? 'selected' : '' }>Offline</option>
																		<option value="HYBRID"
																			${hackathon.eventType=='HYBRID' ? 'selected'
																			: '' }>Hybrid</option>
																	</select>
																</div>
																...
																<div class="cv-form-group">
																	...
																	<select name="payment" id="paymentSelect"
																		...
																		<option value="FREE" ${hackathon.payment=='FREE'
																			? 'selected' : '' }>Free</option>
																		<option value="PAID" ${hackathon.payment=='PAID'
																			? 'selected' : '' }>Paid</option>
																	</select>
																</div>

																<!-- Entry Fee -->
																<div class="cv-form-group" id="feeGroup" <c:if
																	test="${hackathon.payment != 'PAID'}">
																	style="display: none;"</c:if>>
																	<label class="cv-label">Entry Fee (₹)</label> <input
																		type="number" name="fee" id="feeInput"
																		class="cv-input" min="0"
																		placeholder="Enter entry fee in ₹"
																		value="${hackathon.fee}" />
																</div>
																...
																<div class="row">
																	<div class="col-md-6">
																		<div class="cv-form-group">
																			<label class="cv-label">Min Team
																				Size</label>
																			<input type="number" name="minTeamSize"
																				class="cv-input" min="1"
																				value="${hackathon.minTeamSize}"
																				required />
																		</div>
																	</div>
																	<div class="col-md-6">
																		<div class="cv-form-group">
																			<label class="cv-label">Max Team
																				Size</label>
																			<input type="number" name="maxTeamSize"
																				class="cv-input" min="1"
																...
																<div class="cv-form-group">
																	...
																	<input type="text" name="location" class="cv-input"
																...
																<div class="cv-form-group">
																	...
																	<select name="userTypeId" class="cv-select"
																		...
																		<c:forEach items="${allUserType}" var="u">
																			<option value="${u.userTypeId}"
																				${hackathon.userTypeId==u.userTypeId
																				? 'selected' : '' }>${u.userType}
																			</option>
																		</c:forEach>
																	</select>
																...
																<div class="row">
																	<div class="col-md-6">
																		<div class="cv-form-group">
																			<label class="cv-label">Registration
																				Start</label>
																			<input type="date"
																				name="registrationStartDate"
																				id="regStartDate" class="cv-input"
																				value="${hackathon.registrationStartDate}"
																				required />
																		</div>
																	</div>
																	<div class="col-md-6">
																		<div class="cv-form-group">
																			...
																			<input type="date"
																				...
																				id="regEndDate" class="cv-input"
																				value="${hackathon.registrationEndDate}"
																				required />
																		</div>
																	</div>
																</div>
																...
																<div class="row">
																	<div class="col-md-6">
																		<div class="cv-form-group">
																			<label class="cv-label">Event Start
																				Date</label>
																			<input type="date" name="eventStartDate"
																				id="eventStartDate" class="cv-input"
																				value="${hackathon.eventStartDate}" />
																		</div>
																	</div>
																	<div class="col-md-6">
																		<div class="cv-form-group">
																			<label class="cv-label">Event End
																				Date</label>
																			<input type="date" name="eventEndDate"
																				id="eventEndDate" class="cv-input"
																...
																<div class="cv-form-group">
																	...
																	<input type="date" name="submissionDeadline"
																		id="submissionDeadline" class="cv-input"
																		value="${hackathon.submissionDeadline}" />
																	<small class="cv-hint">Teams cannot submit work
																		after this date.</small>
																</div>
																	...
																	<div class="col-md-4">
																		<div class="cv-form-group">
																			...
																			<input type="text" name="firstPrize"
																				class="cv-input"
																				value="${hackathon.firstPrize}"
																				placeholder="e.g. ₹1,00,000" required />
																		</div>
																	</div>
																	<div class="col-md-4">
																		<div class="cv-form-group">
																	...
																	<div class="col-md-4">
																		<div class="cv-form-group">
																			...
																			<input type="text" name="thirdPrize"
																				class="cv-input"
																				value="${hackathon.thirdPrize}"
																				placeholder="e.g. ₹20,000" required />
																		</div>
																	</div>
																</div>
																...
																<div class="cv-actions mt-3">
																	...
																	<a href="listHackathon"
																		class="btn-cv btn-cv-ghost">Cancel</a>
																</div>
