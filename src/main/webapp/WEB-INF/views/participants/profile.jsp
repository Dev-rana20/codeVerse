<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<%-- ── Page Metadata ── --%>
			...
			<c:set var="pageSubtitle" value="View and edit your profile information" scope="request" />
						...
						<div class="container py-5">
							<div class="profile-card">
								...
								<form action="updateProfile" method="post" enctype="multipart/form-data">
									...
									<div class="mb-3">
										<label for="lastName" class="form-label">Last Name</label> <input type="text"
											class="form-control" id="lastName" name="lastName" value="${user.lastName}"
											required>
									</div>
									<div class="mb-3">
